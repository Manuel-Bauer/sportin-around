var urlSignature = (function (exports, Base64, HmacSHA1) {
	...
	var global$C = global$D; // eslint-disable-next-line es-x/no-object-defineproperty -- safe

	var defineProperty$6 = Object.defineProperty;

	var defineGlobalProperty$3 = function (key, value) {
	  try {
	    defineProperty$6(global$C, key, {
	      value: value,
	      configurable: true,
	      writable: true
	    });
	...
	var uncurryThis$l = NATIVE_BIND$3 && bind$4.bind(call$g, call$g);
	...
	var TypeError$f = global$A.TypeError; // `RequireObjectCoercible` abstract operation
	...
	var hasOwnProperty = uncurryThis$k({}.hasOwnProperty); // `HasOwnProperty` abstract operation
	...
	var fails$j = fails$l; // eslint-disable-next-line es-x/no-object-getownpropertysymbols -- required for testing
	...
	var fails$i = fails$l; // Detect IE8's incomplete defineProperty implementation
	...
	var fails$g = fails$l; // V8 ~ Chrome 36-
	...
	var TypeError$e = global$u.TypeError; // `Assert: Type(argument) is Object`
	...
	var TypeError$d = global$r.TypeError; // `Assert: IsCallable(argument) is true`
	...
	var TypeError$c = global$q.TypeError; // `OrdinaryToPrimitive` abstract operation
	...
	var TypeError$a = global$o.TypeError; // eslint-disable-next-line es-x/no-object-defineproperty -- safe
	...
	var EXISTS = hasOwn$a(FunctionPrototype$1, 'name'); // additional protection from minified / mangled / dropped function names
	...
	if (NATIVE_WEAK_MAP || shared$1.state) {
	  ...
	  set = function (it, metadata) {
	    if (hasOwn$9(it, STATE)) throw new TypeError$9(OBJECT_ALREADY_INITIALIZED);
	    metadata.facade = it;
	...
	var Object$3 = global$l.Object; // ES3 wrong here
	...
	if (!TO_STRING_TAG_SUPPORT) {
	  defineBuiltIn$8(Object.prototype, 'toString', toString$6, {
	    unsafe: true
	  });
	}
	...
	var regexpGetFlags = function (R) {
	  var flags = R.flags;
	  return flags === undefined && !('flags' in RegExpPrototype$2) && !hasOwn$7(R, 'flags') && isPrototypeOf$1(RegExpPrototype$2, R) ? call$c(regExpFlags, R) : flags;
	};
	...
	*/
	...
	var fails$b = fails$l;
	var global$h = global$D; // babel-minify and Closure Compiler transpiles RegExp('a', 'y') -> /a/y and it causes SyntaxError
	...
	var fails$a = fails$l;
	var global$g = global$D; // babel-minify and Closure Compiler transpiles RegExp('.', 's') -> /./s and it causes SyntaxError
	...
	var fails$9 = fails$l;
	var global$f = global$D; // babel-minify and Closure Compiler transpiles RegExp('(?<a>b)', 'g') -> /(?<a>b)/g and it causes SyntaxError
	...
	var call$9 = FunctionPrototype.call; // eslint-disable-next-line es-x/no-reflect -- safe
	...
	var TypeError$8 = global$e.TypeError; // `RegExpExec` abstract operation
	...
	var defineIterator$2 = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
	  ...
	  if (IterablePrototype[ITERATOR$5] !== defaultIterator) {
	    defineBuiltIn$3(IterablePrototype, ITERATOR$5, defaultIterator, {
	      name: DEFAULT
	    });
	  }
	...
	var functionBindContext = function (fn, that) {
	  aCallable$1(fn);
	  return that === undefined ? fn : NATIVE_BIND ? bind$3(fn, that) : function ()
	  /* ...args */
	  {
	...
	var RangeError = global$6.RangeError;
